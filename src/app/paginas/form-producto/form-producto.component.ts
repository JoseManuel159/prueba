...
export class FormProductoComponent implements OnInit {
  ...
  unidadesMedida:UnidadMedida[] = []; // Ejemplo de unidades de medida como objetos


  productoSeleccionado:ProductoRepor|null = null;

  constructor(private serviceProducto:ProductoService, private sevicioMarca: MarcaService, private servicioUnidadmedida:UnidadmedidaService,private servicioCategoria: CategoriaService,private fb: FormBuilder) {
  ...
  this.servicioCategoria.marcas$.subscribe(data=>{
    console.log(data);
    this.categorias=data;
  });

  this.servicioUnidadmedida.findAll();
  this.servicioUnidadmedida.marcas$.subscribe(data=>{
    console.log(data);
